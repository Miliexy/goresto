...
class WelcomeView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final _firstHalfAnimation =
        Tween<Offset>(begin: Offset(5, 0), end: Offset(0, 0)).animate(
      CurvedAnimation(
              ...
              children: [
                SlideTransition(
                  ...
                  child: Container(
                    ...
                    constraints: BoxConstraints(maxWidth: SizeConfig.blockSizeHorizontal * 80, maxHeight: SizeConfig.blockSizeVertical * 50),
                    child: Image.asset(
